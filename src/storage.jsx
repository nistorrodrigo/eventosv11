...
.cover-logo{padding:30mm 0 0 25mm;display:flex;align-items:center;gap:14px}
.cover-logo .lg-mark{width:54px;height:54px;background:#fff;border-radius:7px;display:flex;align-items:center;justify-content:center;color:#0c3b82;font-weight:900;font-size:22pt;letter-spacing:-.04em;font-family:Georgia,serif}
.cover-logo .lg-text{font-size:24pt;font-weight:800;letter-spacing:.06em;line-height:1;text-transform:uppercase}
.cover-logo .lg-text small{display:block;font-size:11pt;font-weight:300;letter-spacing:.18em;margin-top:3px}
...
${(()=>{
  ...
  const coverHTML=(e0&&meta.cover!==false&&(e0.coverNames?.length||e0.coverTitle))?`<div class="cover">
    <div class="cover-logo">
      <div class="lg-mark">L</div>
      <div class="lg-text">Latin<small>Securities</small></div>
    </div>
